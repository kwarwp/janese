...
class Persona_control:
    ...
    def __init__(self, nome_do_fundo):
        ...
        self.direita = Elemento(MARCADOR_DIREITA, h=50 , w=50, x=980, y=460,vai=self.anda_direita) #cria um elemento posicionado 'à direita' no joystick
        self.direita.entra(nome_do_fundo)
        
        self.esquerda = Elemento(MARCADOR_ESQUERDA, h=50 , w=50, x=1200, y=460, vai=self.anda_esquerda) #cria um elemento posicionado 'à esquerda' no joystick
