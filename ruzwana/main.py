...
FUNDO = "https://imgur.com/zGuI1k0.png"
PERSONAGEM = "https://imgur.com/VPutH9b.png"
...
class inicial():
    def __init__(self):
        ...
        self.personagem = Elemento(img = PERSONAGEM, cena = self.fundo, x=self.x1, y=self.y1, h=30, w=30)
