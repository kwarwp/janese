...
class cenas:
    ...
    def cena1(self):
        ...
        proxima = Elemento(MARCADOR_PLAY, tit="Próxima Cena",
                               h=130 , w=130, x=1190, y=150, # ou x=eixo_x, y=eixo_y, w=largura, h=altura
...
class Persona_control:
    ...
    def __init__(self, nome_do_fundo):
       ...
       # self.marcadorx = Elemento(MARCADOR_X, h=70 , w=70, x=80, y=450) #cria um elemento posicionado 'acima' no joystick
        ...
        self.cima = Elemento(MARCADOR_CIMA, h=70 , w=70, x=1200, y=470, vai=self.anda_cima) #cria um elemento posicionado 'acima' no joystick
        self.cima.entra(nome_do_fundo)
        
        self.baixo = Elemento(MARCADOR_BAIXO, h=70 , w=70, x=1200, y=570, vai=self.anda_baixo) #cria um elemento posicionado 'abaixo' no joystick
