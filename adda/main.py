...
class Persona_control:
    ...
    def __init__(self, nome_do_fundo):
        ...
        self.cima = Elemento(MARCADOR_CIMA, h=80 , w=80, x=1280, y=450, vai=self.anda_cima) #cria um elemento posicionado 'acima' no joystick
        self.cima.entra(nome_do_fundo)
        
        self.baixo = Elemento(MARCADOR_BAIXO, h=80 , w=80, x=1280, y=600, vai=self.anda_baixo) #cria um elemento posicionado 'abaixo' no joystick
