...
class Persona_control:
    ...
    def __init__(self, nome_do_fundo):
        ...
        self.cima = Elemento(MARCADOR_CIMA, h=80 , w=80, x=1080, y=450, vai=self.anda_cima) #cria um elemento posicionado 'acima' no joystick
        self.cima.entra(nome_do_fundo)
        
        self.baixo = Elemento(MARCADOR_BAIXO, h=80 , w=80, x=1080, y=600, vai=self.anda_baixo) #cria um elemento posicionado 'abaixo' no joystick
        self.baixo.entra(nome_do_fundo)
        
        self.direita = Elemento(MARCADOR_DIREITA, h=80 , w=80, x=900, y=490,vai=self.anda_direita) #cria um elemento posicionado 'à direita' no joystick
        self.direita.entra(nome_do_fundo)
        
        self.esquerda = Elemento(MARCADOR_ESQUERDA, h=80 , w=80, x=1040, y=490, vai=self.anda_esquerda) #cria um elemento posicionado 'à esquerda' no joystick
